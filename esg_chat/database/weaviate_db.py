...
class Weaviate:
    def __init__(self):
        self._url = config["database"]["weaviate"]["url"]
        self._base_schema_path = config["database"]["weaviate"]["schema_file"]
        
        self._key = config["database"]["weaviate"]["key"]
...
class WeaviateMetric:
    def __init__(self):
        self._url = config["database"]["weaviate"]["url"]
        self._base_schema_path = config["database"]["weaviate"]["metric_schema_file"]
