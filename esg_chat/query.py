import json
from esg_chat.database.weaviate_db import Weaviate
from esg_chat.model.bam import Bam
from esg_chat.model.watsonx import Watsonx

from config import config, logger


def query(input_string: str, class_name: str, properties: list) -> json:
